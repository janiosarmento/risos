...
function app() {
    return {
        ...
        // true/false once /admin/validate-secret has answered). Never carries the key itself.
        get janoSecretValid() { return Alpine.store('prefs').janoSecretValid; },
        set janoSecretValid(v) { Alpine.store('prefs').janoSecretValid = v; },
        ...
        get backgroundJanoSecretValid() { return Alpine.store('prefs').backgroundJanoSecretValid; },
        set backgroundJanoSecretValid(v) { Alpine.store('prefs').backgroundJanoSecretValid = v; },
